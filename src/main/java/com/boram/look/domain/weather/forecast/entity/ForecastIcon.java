...
public enum ForecastIcon {
    CLEAR_DAY(1, "맑음"),
    CLEAR_NIGHT(2, "맑음"),
    PARTLY_CLOUDY_DAY(3, "구름 조금"),
    PARTLY_CLOUDY_NIGHT(4, "구름 조금"),
    MOSTLY_CLOUDY_DAY(5, "구름 많음"),
    MOSTLY_CLOUDY_NIGHT(6, "구름 많음"),
    CLOUDY(7, "흐림"),
    SHOWER(8, "소나기"),
    RAIN(9, "비"),
    LIGHT_RAIN_DAY(10, "가끔 비"),
    LIGHT_RAIN_NIGHT(11, "가끔 비"),
    SNOW(12, "눈"),
    LIGHT_SNOW_DAY(13, "가끔 눈"),
    LIGHT_SNOW_NIGHT(14, "가끔 눈"),
    RAIN_AND_SNOW(15, "비 또는 눈"),
    LIGHT_RAIN_OR_SNOW_DAY(16, "가끔 비 또는 눈"),
    LIGHT_RAIN_OR_SNOW_NIGHT(17, "가끔 비 또는 눈"),
